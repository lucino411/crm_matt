...
class LeadCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            ...
            recipient_list=['test2@mail.com', 'test3@mail.com']
        )
...
class LeadAssignAgentView(OrganisorAndLoginRequiredMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        lead.agent = agent
        lead.save()
        return super(LeadAssignAgentView, self).form_valid(form)
...
# -----------------------------
# OTRAS FORMAS BASADA EN FUNCIONES
# -----------------------------
